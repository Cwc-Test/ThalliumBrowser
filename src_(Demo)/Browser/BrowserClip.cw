package  {
	...
	public class BrowserClip extends Clip {
		...
		//	var oFont : RcFont = new RcFont( "c:/extra_fonts/ProggyClean.ttf");
			 oFont = new RcFont( "Exe|Rc/Fonts/ProggyTiny.ttf", 10);
...
*/
		...
		public function fDraw_text(_sText:String, _nX : Int, _nY: Int, _nWidth : Int, _nHeight: Int):Void {
			Debug.fTrace("DRAW HERE: " + _sText);
